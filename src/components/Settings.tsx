...
export function Settings({ options, setOptions, disabled, chooseOutput, desktop, directOutput, outputLabel, onClose }: {
  ...
  return <aside className="panel settings">
    ...
    <fieldset disabled={disabled}>
      <label className="field-label field-label-spaced" htmlFor="mode">{t('settings.mode')}</label>
      ...
      <div className="range-labels"><span>{t('settings.faster')}</span><span>{t('settings.smaller')}</span></div>
