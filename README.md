...
- потоковый JSONL-отчёт с результатом каждого файла;
...
5. Проверьте итог и JSONL-отчёт в каталоге назначения.
...
SHA-256 восстановленного файла должен совпасть со значением `sha256` в отчёте.
